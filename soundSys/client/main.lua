...
------
-- RegisterNetEvent pz_corecl:PlayOnOne
--
...
------
RegisterNetEvent('pz_corecl:PlayOnOne')
AddEventHandler('pz_corecl:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
-- RegisterNetEvent pz_corecl:PlayOnAll
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterNetEvent('pz_corecl:PlayOnAll')
AddEventHandler('pz_corecl:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
-- RegisterNetEvent pz_corecl:PlayWithinDistance
--
...
------
RegisterNetEvent('pz_corecl:PlayWithinDistance')
AddEventHandler('pz_corecl:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
